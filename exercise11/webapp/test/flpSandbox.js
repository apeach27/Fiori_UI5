		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#synce05exercise11-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce05exercise11-display": {
								"semanticObject": "synce05exercise11",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e05.exercise11",
									"url": sap.ui.require.toUrl("sync/e05/exercise11")
								}
							}
						}
					}
