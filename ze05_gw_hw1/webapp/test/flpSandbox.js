		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ui5과제",
									"targetURL": "#ui5tablefragmentze05gwhw1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ui5tablefragmentze05gwhw1-display": {
								"semanticObject": "ui5tablefragmentze05gwhw1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui5tablefragment.ze05gwhw1",
									"url": sap.ui.require.toUrl("ui5tablefragment/ze05gwhw1")
								}
							}
						}
					}
