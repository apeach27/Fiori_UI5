		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 1번 문제리뷰 E05",
									"targetURL": "#synce05ux1review-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce05ux1review-display": {
								"semanticObject": "synce05ux1review",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e05.ux1review",
									"url": sap.ui.require.toUrl("sync/e05/ux1review")
								}
							}
						}
					}
