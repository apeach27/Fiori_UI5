		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 3번 문제리뷰 e05",
									"targetURL": "#synce05ex3review-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce05ex3review-display": {
								"semanticObject": "synce05ex3review",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e05.ex3review",
									"url": sap.ui.require.toUrl("sync/e05/ex3review")
								}
							}
						}
					}
