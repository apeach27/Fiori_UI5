					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 4번 문제 E05",
									"targetURL": "#synce05ex4-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"synce05ex4-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e05.ex4",
									"url": sap.ui.require.toUrl("sync/e05/ex4")
								}
							}
						}
					}
