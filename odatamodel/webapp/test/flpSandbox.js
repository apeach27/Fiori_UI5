		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OData 모델로 CRUD 구현",
									"targetURL": "#synce05odatamodel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce05odatamodel-display": {
								"semanticObject": "synce05odatamodel",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e05.odatamodel",
									"url": sap.ui.require.toUrl("sync/e05/odatamodel")
								}
							}
						}
					}
