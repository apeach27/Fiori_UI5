		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#synczebglchart-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synczebglchart-display": {
								"semanticObject": "synczebglchart",
								"action": "display",
								"description": "GL계정과목 금액",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.zeb.glchart",
									"url": sap.ui.require.toUrl("sync/zeb/glchart")
								}
							}
						}
					}
