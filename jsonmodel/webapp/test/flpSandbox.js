		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "JSON Model 연습",
									"targetURL": "#synce05jsonmodel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce05jsonmodel-display": {
								"semanticObject": "synce05jsonmodel",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e05.jsonmodel",
									"url": sap.ui.require.toUrl("sync/e05/jsonmodel")
								}
							}
						}
					}
