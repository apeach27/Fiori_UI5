		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#synczebaccountview-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synczebaccountview-display": {
								"semanticObject": "synczebaccountview",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.zeb.accountview",
									"url": sap.ui.require.toUrl("sync/zeb/accountview")
								}
							}
						}
					}
