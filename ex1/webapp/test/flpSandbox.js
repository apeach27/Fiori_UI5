					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 1번 문제 E05",
									"targetURL": "#synce05ex1-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"synce05ex1-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e05.ex1",
									"url": sap.ui.require.toUrl("sync/e05/ex1")
								}
							}
						}
					}
