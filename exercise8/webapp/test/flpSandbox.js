		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#synce05exercise8-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce05exercise8-display": {
								"semanticObject": "synce05exercise8",
								"action": "display",
								"description": "UX400 연습문제",
								"title": "Create and Use Fragments",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e05.exercise8",
									"url": sap.ui.require.toUrl("sync/e05/exercise8")
								}
							}
						}
					}
