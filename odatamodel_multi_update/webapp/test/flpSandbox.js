		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OData 모델을 통한 다중 데이터 변경",
									"targetURL": "#synce05odatamodelmultiupdate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce05odatamodelmultiupdate-display": {
								"semanticObject": "synce05odatamodelmultiupdate",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e05.odatamodelmultiupdate",
									"url": sap.ui.require.toUrl("sync/e05/odatamodelmultiupdate")
								}
							}
						}
					}
