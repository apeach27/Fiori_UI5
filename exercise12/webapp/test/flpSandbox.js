		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Use Data Types and Input alidation",
									"targetURL": "#synce05exercise12-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce05exercise12-display": {
								"semanticObject": "synce05exercise12",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e05.exercise12",
									"url": sap.ui.require.toUrl("sync/e05/exercise12")
								}
							}
						}
					}
