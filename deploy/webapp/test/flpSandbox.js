		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5 전표조회",
									"targetURL": "#synce05deploy-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce05deploy-display": {
								"semanticObject": "synce05deploy",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e05.deploy",
									"url": sap.ui.require.toUrl("sync/e05/deploy")
								}
							}
						}
					}
