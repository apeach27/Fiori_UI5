		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "다중 데이터 삭제",
									"targetURL": "#synce05odatamodelmultidelete-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce05odatamodelmultidelete-display": {
								"semanticObject": "synce05odatamodelmultidelete",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e05.odatamodelmultidelete",
									"url": sap.ui.require.toUrl("sync/e05/odatamodelmultidelete")
								}
							}
						}
					}
