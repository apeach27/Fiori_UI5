		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "입력필드의 값 다뤄보기",
									"targetURL": "#synce05input-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce05input-display": {
								"semanticObject": "synce05input",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e05.input",
									"url": sap.ui.require.toUrl("sync/e05/input")
								}
							}
						}
					}
