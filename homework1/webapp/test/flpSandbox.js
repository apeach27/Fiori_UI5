		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Table &amp; Fragment 활용하기",
									"targetURL": "#synce05homework1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce05homework1-display": {
								"semanticObject": "synce05homework1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e05.homework1",
									"url": sap.ui.require.toUrl("sync/e05/homework1")
								}
							}
						}
					}
