					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 3번 문제 E05",
									"targetURL": "#synce05ex3-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"synce05ex3-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e05.ex3",
									"url": sap.ui.require.toUrl("sync/e05/ex3")
								}
							}
						}
					}
