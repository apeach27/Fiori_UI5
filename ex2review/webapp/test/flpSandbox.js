		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 2번 문제 리뷰 e05",
									"targetURL": "#synce05ex2review-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce05ex2review-display": {
								"semanticObject": "synce05ex2review",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e05.ex2review",
									"url": sap.ui.require.toUrl("sync/e05/ex2review")
								}
							}
						}
					}
