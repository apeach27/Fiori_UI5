					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 2번 문제 E05",
									"targetURL": "#synce05ex2-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"synce05ex2-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e05.ex2",
									"url": sap.ui.require.toUrl("sync/e05/ex2")
								}
							}
						}
					}
